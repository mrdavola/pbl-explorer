...
function Step4({ onNext }: { onNext: () => void }) {
  return (
    <div className="flex flex-col flex-1">
      ...
      <DragSort
        items={[
          { id: "a", label: "Write the driving question", correctZone: "human" },
          { id: "b", label: "Generate research topic ideas", correctZone: "ai" },
          { id: "c", label: "Decide the public product format", correctZone: "human" },
          { id: "d", label: "Create a rubric", correctZone: "ai" },
          { id: "e", label: "Facilitate peer critique", correctZone: "human" },
          { id: "f", label: "Draft a day-by-day calendar", correctZone: "ai" },
          { id: "g", label: "Build relationships with community partners", correctZone: "human" },
          { id: "h", label: "Generate reflection prompts", correctZone: "either" },
        ]}
        zones={[
